...
namespace InfinityPBR
{
    public static class InfinityExtensions
    {
        ...
        */
        ...
        /// <typeparam name="T"></typeparam>
        /// <returns></returns>
        public static T TakeRandom<T>(this List<T> list) => list[Random.Range(0, list.Count)];
        ...
        /// <typeparam name="T"></typeparam>
        /// <returns></returns>
        public static int TakeRandomIndex<T>(this List<T> list) => Random.Range(0, list.Count);
