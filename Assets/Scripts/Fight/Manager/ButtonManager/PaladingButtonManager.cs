...
public class PaladinButtonManager : MonoBehaviour
{
    public static PaladinButtonManager Instance;
    ...
    private void SetSpell_1Text()
    {
        ...
        actionDescriptionDescriptionText.text = "Deal " + heroToAct.damage + " damage to 1 enemy and gain 5 armor for this fight";
    }
    private void SetSpell_2Text()
    {
        ActionDescriptionPanel.transform.position = DescriptionPanelPosition_2;
        actionDescriptionHeaderText.text = "Spell_2";
        actionDescriptionDescriptionText.text = "Heal a target and yourself for " + heroToAct.healModifier;
    }
