...
public class RogueButtonManager : MonoBehaviour
{
    public static RogueButtonManager Instance;
    ...
    private void SetSpell_1Text()
    {
        ...
        actionDescriptionDescriptionText.text = "Increase this units damage for this fight by 20";
    }
