...
public class WizardButtonManager : MonoBehaviour
{
    public static WizardButtonManager Instance;
    ...
    private void SetSpell_2Text()
    {
        ...
        actionDescriptionDescriptionText.text = "Deal " + (heroToAct.damage/2) + " damage to all enemies";
    }
