...
public class BatBehaviour : BaseEnemyBehaviour
{
    public TargetableUnit unitStats;
    [SerializeField] private HealthbarHandler healthbarHandler;
    public BatAnimationScript batAnimationScript;
    ...
    public override void Attack()
    {
        ...
        if (chance == 1)
        {
            batAnimationScript.Attack1Animation();
        }
        if (chance == 2)
        {
            batAnimationScript.Attack2Animation();
        }
    }
    ...
    {
        batAnimationScript.GotHitAnimation();
    }
    public override void DeathAnimation()
    {
        batAnimationScript.DeathAnimation();
    }
    public override void HealAnimation() // Dodge Animation for bat because has no taunt
    {
        batAnimationScript.DodgeAnimation();
    }
}
