...
public class SnakeBehaviour : BaseEnemyBehaviour
{
    public TargetableUnit unitStats;
    [SerializeField] private HealthbarHandler healthbarHandler;
    public SnakeAnimationScript snakeAnimationScript;
    ...
    public override void Attack()
    {
        ...
        if (chance == 1)
        {
            snakeAnimationScript.Attack1Animation();
        }
        if (chance == 2)
        {
            snakeAnimationScript.Attack2Animation();
        }
        if (chance == 3)
        {
            snakeAnimationScript.Attack3Animation();
        }
    }
    ...
    {
        snakeAnimationScript.GotHitAnimation();
    }
    public override void DeathAnimation()
    {
        snakeAnimationScript.DeathAnimation();
    }
    public override void HealAnimation()
    {
        snakeAnimationScript.TauntAnimation();
    }
}
